...
def main():
    ...
    df_entropy, df_zscore = read_csv_files(
        "240501_01_entropy-values.csv", "240603_01_mtx_motif_zscore.csv"
    )

    # Transpose the DataFrame and save it
    df_zscore_T = transpose_and_save_df(
        df_zscore, "Transposed_240603_01_mtx_motif_zscore.csv"
    )
